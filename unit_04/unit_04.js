...
function f7() {
    ...
    const out1 = document.querySelector('.out-71');
    const out2 = document.querySelector('.out-72');
...
function f12() {
    ...
    console.log(document.querySelector('.i-12'));
...
function f14() {
    let i = document.querySelector('.t-14').value;
...
function f16() {
    ...
    let i = document.querySelector('.s-16').value;
...
function f17() {
    let i = document.querySelector('.s-17').value;
...
function f19() {
    let out = document.querySelector('.out-19').innerHTML;
    console.log(out);
    let i = document.querySelector('.i-19');
    i.value = out;
}
