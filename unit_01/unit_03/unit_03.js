...
function f3() {
    const i1 = +document.querySelector('.i-31').value;
    const i2 = +document.querySelector('.i-32').value;
...
function f7() {
    const i1 = +document.querySelector('.i-71').value,
        i2 = +document.querySelector('.i-72').value,
...
function f8() {
    const s = +document.querySelector('.s-8').value;
...
function f10() {
    const i = document.querySelector('.s-100').value,
...
function f11() {
    const i = document.querySelector('.s-110').value,
...
function f14() {
    const a = +document.querySelector('.i-141').value,
        b = +document.querySelector('.i-142').value,
        s = document.querySelector('.s-143').value,
...
function f15() {
    const a = +document.querySelector('.s-151').value,
        b = +document.querySelector('.s-152').value,
        s = document.querySelector('.s-153').value,
