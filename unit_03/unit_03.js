...
function f7() {
    ...
    document.querySelector('.out-7').innerHTML = Math.pow(i1, i2)
...
function f10() {
    let s = +document.querySelector('.s-100').value
...
function f11() {
    ...
    document.querySelector('.out-11').innerHTML = s;
}
...
function f15() {
       let i1 = +document.querySelector('.s-151').value;
       let i2 = +document.querySelector('.s-152').value;
