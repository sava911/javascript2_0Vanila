...
function t10() {
    const i = +document.querySelector('.i-10').value,
...
function t12() {
    const name = document.querySelector('.i-12-1').value,
        famos = document.querySelector('.i-12-2').value,
        out = document.querySelector('.out-12');

    out.innerHTML = `Hello ${name} ${famos}`
...
function t19() {
const i1 = +document.querySelector('.i-19-1').value
const i2 = +document.querySelector('.i-19-2').value
